...
public class HttpRequester {
	...
	// 简单的header请求
	public static InputStream httpHeader(Context context, String path, HashMap<String, String> paramMap, String format)
...
//		}
	...
	public static InputStream doHttpRequestJson(Context context, String path, String xml) throws NetException, Exception {
		URL url = new URL(path);
		HttpURLConnection conn = null;
		// 查看apn类型
		String typeName = NetTool.getNetType(context);
	...
	public static InputStream doHttpGet(Context context, String path, String content) throws NetException, Exception {
		URL url = new URL(path);
		HttpURLConnection conn = null;
		// 查看apn类型
		String typeName = NetTool.getNetType(context);
	...
	public static InputStream doHttpRequestPostJson(Context context, String path, String json) throws NetException, Exception {
		return doHttpRequestJson(context, path, json);
	}

	public static InputStream doHttpRequestGetJson(Context context, String path, String json) throws NetException, Exception {
		return doHttpGet(context, path, json);
	}
